...
namespace Goblinfactory.Konsole.Platform.Windows
{
    ...
    public partial class Kernel32Draw
    {
        ...
        public static void SelfTest()
        {
            ...
            {
                var w = new Window();
                var height = w.WindowHeight;
                var width = w.WindowWidth;
                ...
                for(int background = 550; background>= 0; background--)
                {
                    ...
                    bool b = WriteConsoleOutputW(h, buf,
                        new XY() { X = (short)width, Y = (short)height }, // buffer size
                        new XY() { X = 0, Y = 0 },  // where on the actual console will we be writing.
                        ref rect);
                }
            }
        }
